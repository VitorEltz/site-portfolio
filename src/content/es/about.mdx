...
<BaseLayout lang="es" title="About | Vitor Eltz" description="About Vitor Eltz">
	<div class="stack gap-20">
		<main class="wrapper about">
			<Hero
				title="About"
				tagline="Gracias por visitar. Lee a continuaci00f3n para saber m00e1s sobre m00ed y mi trayectoria."
			>
			...
			<section>
				<h2 class="section-title">Educaci00f3n</h2>
				<div class="content">
