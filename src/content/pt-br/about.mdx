...
<BaseLayout lang="pt-BR" title="About | Vitor Eltz" description="About Vitor Eltz">
	<div class="stack gap-20">
		<main class="wrapper about">
			<Hero
				title="About"
				tagline="Obrigado por visitar. Leia abaixo para saber mais sobre mim e minha trajet00f3ria."
			>
				<ImageCarousel images={[
					{ src: '/assets/photo.jpeg', alt: 'Vitor Eltz at work' },
					{ src: '/assets/azion-launch-week.jpeg', alt: 'Another photo' }
				]} />
			</Hero>

			<section>
				<h2 class="section-title">Hist00f3rico</h2>
				<div class="content">
					<p>
			...
			<section>
				<h2 class="section-title">Educa00e700e3o</h2>
				<div class="content">
